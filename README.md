...
The cleaned data was exported from Python into a relational database using SQLAlchemy to enable structured business querying.  

3. Business Analysis (SQL)
Key business questions addressed via SQL include:
...
📂 Project Structure
customer_behavior_analysis.ipynb: Python notebook for EDA and cleaning.
